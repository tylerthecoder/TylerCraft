...
class TextureClass {
  ...
  // start asynchronously loading all of the images then turn them into
  ...
  private loadTextureFromUrl(url: string, gl: WebGLRenderingContext) {
...
const TextureService = new TextureClass();
